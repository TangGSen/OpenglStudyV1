 ...
 * Version: 1.0
 * On     : 2017/9/26 15:57
 * Des    : 绘制点，螺旋线点，onDrawFrame，点的设置每次绘制都需要重新设置
 *          把点的绘制放在初始SPointRendererV2
 *          这样更新时会提高5-7ms
 */

public class SPointRendererV2 implements GLSurfaceView.Renderer{
    public float xroate;
    public float yroate;
    public float zroate;
    ...
    public SPointRendererV2(){
        ...
        byteBuffer = ByteBuffer.allocateDirect(points.size()*4);
