...
unsigned char *loadFile(const char *path, int &fileSize) {
 ...
 void JNICALL Java_sen_com_openglstudyv2_CameraSGLNative_initAssetManager
...
JNIEXPORT void JNICALL Java_sen_com_openglstudyv2_CameraSGLNative_onSurfaceCreated
...
JNIEXPORT void JNICALL Java_sen_com_openglstudyv2_CameraSGLNative_onSurfaceChanged
...
JNIEXPORT void JNICALL Java_sen_com_openglstudyv2_CameraSGLNative_onDrawFrame
        (JNIEnv *env, jclass clzss) {
    draw();

};

JNIEXPORT jobject JNICALL Java_sen_com_openglstudyv2_CameraSGLNative_getSurfaceTexture
        (JNIEnv *, jclass){
